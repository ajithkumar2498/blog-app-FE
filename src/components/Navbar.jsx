      ...
      <div className="w-full h-16 md:h-20 flex items-center justify-between">
        ...
        <div className="md:hidden">
          ...
          >
            ...
            {/* <p >{user}</p> */}
            <button className="flex py-2 px-4 rounded-3xl bg-blue-800 text-white hover:bg-blue-400 hover:text-blue-950">
              Logout{" "}
              <span className="font-xl pt-1">
                <IoLogOut />
              </span>{" "}
            </button>
          </div>
        ...
        <div className="hidden md:flex items-center gap-8 xl:gap-12 font-medium">
          ...
          <button
            ...
            className="flex py-2 px-4 rounded-3xl bg-blue-800 text-white hover:bg-blue-400 hover:text-blue-950"
          >
            Logout{" "}
            <span className="font-xl pt-1">
              <IoLogOut />
